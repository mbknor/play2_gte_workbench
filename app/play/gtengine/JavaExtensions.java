...
public class JavaExtensions {
    ...
    public static RawData escapeHtml(String htmlToEscape) {
        return new RawData(org.apache.commons.lang.StringEscapeUtils.escapeHtml(htmlToEscape));
    }
    ...
    public static RawData raw(Object val) {
        return new RawData(val.toString());
    }
    ...
    public static RawData asAttr(Map attributes) {
        ...
        return new RawData(buf.toString());
    }
    ...
    public static String format(Number number, String pattern) {
        // TODO: Locale support
        DecimalFormatSymbols symbols = new DecimalFormatSymbols(); // needs locale
    ...
    public static String asdate(Long timestamp, String pattern) {
        ...
        return asdate(timestamp, pattern, null);
    }
    ...
    public static String urlEncode(String entity) {
        try {
            ...
            // TODO: don't know how to log via play java api
            e.printStackTrace();
        }
        return entity;
    }
